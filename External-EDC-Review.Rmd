...
`r if(is.character(params$data4)){knitr::asis_output("DSYN03(Were the reading devices uploaded?) should be either Yes or No")}` `r if(is.character(params$data4)){colorize(cad3[!str_detect(cad3$DSYN04,regex("Yes|No",ignore_case = T)),]$Subject,"red")}`
...
str_length(sa$DUDTC02) != median(str_length(sa$DUDTC02),na.rm = T) |
# Application Time (C)
...
`r if(is.character(params$data20)){knitr::asis_output("Length of DUDTC02(Application Date) should be")}` `r if(is.character(params$data20)){colorize(median(str_length(sa$DUDTC02),na.rm = T),"red")}` `r if(is.character(params$data20)){colorize(sa[str_length(sa$DUDTC02) != median(str_length(sa$DUDTC02),na.rm = T),]$Subject,"red")}`
