...
`r if(is.character(params$data1)){htmltools::a("Adverse Event Report",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/AE_Report.pdf")}`
...
str_detect(ae1$AEREL01,"Related|Possibly Related") & (str_detect(ae1$AEEVNT01,"^$|pattern") | is.na(ae1$AENUM04) | str_detect(ae1$AECOM04,"^$|pattern")) |
...
`r if(is.character(params$data1)){knitr::asis_output("AEREL01 (Is this adverse event related to a Study Device?) is not related, so AEEVNT01(Was the adverse event an unanticipated or anticipated event?) and AENUM04(Sensor Number) should be blank at the same time")}` `r if(is.character(params$data1)){colorize(ae1[str_detect(ae1$AEREL01,"Not Related") & str_detect(str_to_lower(ae1$AEEVNT01),"anticipated|unanticipated"),]$Subject,"red")}`

`r if(is.character(params$data1)){knitr::asis_output("AEREL01 (Is this adverse event related to a Study Device?) is possibly related or related, so AEEVNT01(Was the adverse event an unanticipated or anticipated event?) and AENUM04(Sensor Number) should not be blank")}`
`r if(is.character(params$data1)){colorize(ae1[str_detect(ae1$AEREL01,"Related|Possibly Related") & (str_detect(ae1$AEEVNT01,"^$|pattern") | is.na(ae1$AENUM04)),]$Subject,"red")}`
...
`r if(is.character(params$data2)){htmltools::a("Adverse Event Report",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/AE_Report.pdf")}`
...
`r if(is.character(params$data3)){htmltools::a("Clinic Visit 2 Admission and Discharge",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/CV2_Admission_Discharge.pdf")}`
...
cad2$DSDTC02 < cad2$DSDTC01 & !str_detect(cad2$DSYN02,"Not required if Date confirmed is prior to this Visit Date") |
...
`r if(is.character(params$data3)){knitr::asis_output("DSYN03(Is at least one sensor working properly upon discharge?) shoud be either Yes or No")}` `r if(is.character(params$data3)){colorize(cad2[!str_detect(cad2$DSYN03,regex("Yes|No",ignore_case = T)),]$Subject,"red")}`
...
`r if(is.character(params$data4)){htmltools::a("Clinic Visit 3 Admission and Discharge",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/CV3_Admission_Discharge.pdf")}`
...
`r if(is.character(params$data4)){knitr::asis_output("DSYN02(VENOUS ACCESS SUCESSFUL?) should not be blank")}` `r if(is.character(params$data4)){colorize(cad3[!str_detect(cad3$DSYN02,regex("Yes|No",ignore_case = T)),]$Subject,"red")}`

`r if(is.character(params$data4)){knitr::asis_output("DSTM01(Time IV port established) should not be blank")}` `r if(is.character(params$data4)){colorize(cad3[str_detect(cad3$DSYN02,regex("Yes",ignore_case = T)) & str_detect(cad3$DSTM01,"^$|pattern"),]$Subject,"red")}`

`r if(is.character(params$data4)){knitr::asis_output("DSYN03(VENOUS ACCESS REMOVAL TIME) should be either Yes or NA")}` `r if(is.character(params$data4)){colorize(cad3[!str_detect(cad3$DSYN03,regex("Yes|NA",ignore_case = T)),]$Subject,"red")}`

`r if(is.character(params$data4)){knitr::asis_output("DSTM02(Time IV port removed) should not be blank")}` `r if(is.character(params$data4)){colorize(cad3[str_detect(cad3$DSYN03,regex("Yes",ignore_case = T)) & str_detect(cad3$DSTM02,"^$|pattern"),]$Subject,"red")}`

`r if(is.character(params$data4)){knitr::asis_output("DSYN04(Was subject's reader data uploaded?) should not be blank")}` `r if(is.character(params$data4)){colorize(cad3[!str_detect(cad3$DSYN04,regex("Yes|No",ignore_case = T)),]$Subject,"red")}`
...
`r if(is.character(params$data6)){htmltools::a("Medications",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/Medications.pdf")}`
...
`r if(is.character(params$data6) && is_empty(cm1$Subject)){knitr::asis_output(colorize("CM1 is empty","red"))}`
...
`r if(is.character(params$data7)){htmltools::a("Medications",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/Medications.pdf")}`
...
str_length(cm2$CMSTDTC) != median(str_length(cm2$CMSTDTC),na.rm = T)            |
...
`r if(is.character(params$data7)){knitr::asis_output("Length of CMSTDTC(Start Date) should be")}` `r if(is.character(params$data7)){colorize(median(str_length(cm2$CMSTDTC),na.rm = T),"red")}``r if(is.character(params$data7)){knitr::asis_output(",so")}` `r if(is.character(params$data7)){colorize(cm2[str_length(cm2$CMSTDTC) != median(str_length(cm2$CMSTDTC),na.rm = T),]$Subject,"red")}`
...
`r if(is.character(params$data8)){htmltools::a("Comments",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/Comments.pdf")}`
...
co <- co %>% 
      filter(!str_detect(COYN,regex("CHECK HERE IF NO DATA RECORDED|no_data_recorded",ignore_case = T))) %>%
      mutate(Subject = as.character(Subject)) %>% 
      arrange(Subject)
```
...
`r if(is.character(params$data9)){htmltools::a("Device Incident Report",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/Device_Incident_Report.pdf")}`
...
str_length(de$DETM01) != median(str_length(de$DETM01),na.rm = T)            |
# Reader
...
`r if(is.character(params$data9)){knitr::asis_output("Length of DETM01(Time Incident First Noticed) should be")}` `r if(is.character(params$data9)){colorize(median(str_length(de$DETM01),na.rm = T),"red")}` `r if(is.character(params$data9)){colorize(de[str_length(de$DETM01) != median(str_length(de$DETM01),na.rm = T),]$Subject,"red")}`
...
`r if(is.character(params$data10)){htmltools::a("Demographics",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/Demographics.pdf")}`
...
`r if(is.character(params$data11)){htmltools::a("Final Data Upload Log",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/Final_DataUpload_Log.pdf")}`
...
str_length(du2$UPDTC01) != median(str_length(du2$UPDTC01),na.rm = T)                        | 
# Time of Upload
...
`r if(is.character(params$data11)){knitr::asis_output("Length of UPDTC01(Date of Upload) should be")}` `r if(is.character(params$data11)){colorize(median(str_length(du2$UPDTC01),na.rm = T),"red")}` `r if(is.character(params$data11)){colorize(du2[str_length(du2$UPDTC01) != median(str_length(du2$UPDTC01),na.rm = T),]$Subject,"red")}`
...
`r if(is.character(params$data12)){htmltools::a("Eligibility",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/Eligibility.pdf")}`
...
str_detect(ie$IEORES01,regex("Yes",ignore_case = T)) & (is.na(ie$IEDTC02) | str_detect(ie$IETM01,"^$|pattern")) |
# If no, Please provide the Inclusion/Exclusion Number(s) not satisfied
str_detect(ie$IEORES01,regex("No",ignore_case = T)) & str_detect(ie$IEREAS,"^$|pattern"),] %>%
  select(-c(`StudyStatus`,`SubjectID`:`__ITEMGROUPREPEATKEY`)) %>%
...
`r if(is.character(params$data12)){knitr::asis_output("IEDTC02(Date Informed Consent Form was signed) should not be blank")}` `r if(is.character(params$data12)){colorize(ie[(is.na(ie$IEDTC02) | str_detect(ie$IEDTC02,"^$|pattern")),]$Subject,"red")}`

`r if(is.character(params$data12)){knitr::asis_output("Length of IEDTC02(Date Informed Consent Form was signed) should be")}` `r if(is.character(params$data12)){colorize(median(str_length(ie$IEDTC02),na.rm = T),"red")}``r if(is.character(params$data12)){colorize(ie[str_length(ie$IEDTC02) != median(str_length(ie$IEDTC02),na.rm = T),]$Subject,"red")}`

`r if(is.character(params$data12)){knitr::asis_output("IETM01(Time Informed Consent Form was signed) should not be blank")}` `r if(is.character(params$data12)){colorize(ie[(is.na(ie$IETM01) | str_detect(ie$IETM01,"^$|pattern")),]$Subject,"red")}`

`r if(is.character(params$data12)){knitr::asis_output("Length of IETM01(Time Informed Consent Form was signed) should be")}` `r if(is.character(params$data12)){colorize(median(str_length(ie$IETM01),na.rm = T),"red")}` `r if(is.character(params$data12)){colorize(ie[str_length(ie$IETM01) != median(str_length(ie$IETM01),na.rm = T),]$Subject,"red")}`
...
`r if(is.character(params$data12)){knitr::asis_output("If IEORES01(Did Subject meet all the Inclusion Criteria and none of the Exclusion Criteria?) is Yes, IEDTC02(Date Informed Consent Form was signed) and IETM01(Time Informed Consent Form was signed) should not be blank")}` `r if(is.character(params$data12)){colorize(ie[str_detect(ie$IEORES01,regex("Yes",ignore_case = T)) & (is.na(ie$IEDTC02) | str_detect(ie$IETM01,"^$|pattern")),]$Subject,"red")}`

`r if(is.character(params$data12)){knitr::asis_output("If IEORES01(Did Subject meet all the Inclusion Criteria and none of the Exclusion Criteria?) is No, IEREAS(Please provide the Inclusion/Exclusion Number(s) not satisfied) should not be blank")}` `r if(is.character(params$data12)){colorize(ie[str_detect(ie$IEORES01,regex("No",ignore_case = T)) & str_detect(ie$IEREAS,"^$|pattern"),]$Subject,"red")}`
...
`r if(is.character(params$data13)){htmltools::a("IV Sample Collection",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/IV_Sample_Collection.pdf")}`
...
`r if(is.character(params$data14)){htmltools::a("IV Sample Collection",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/IV_Sample_Collection.pdf")}`
...
`r if(is.character(params$data15)){htmltools::a("Diabetes History",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/Diabetes History.pdf")}`
...
# How long has the subject been using insulin? (N)
is.na(mh1$MHORES02) & str_detect(mh1$MHORES03,"^$|pattern") |
# Does the subject use a pump for insulin administration? (C)
!str_detect(mh1$MHORES04,regex("Yes|No",ignore_case = T)) |
# Does the subject require multiple daily insulin injections? (C)
!str_detect(mh1$MHORES05,regex("Yes|No",ignore_case = T)) |
# If yes, Start date of insulin injection and number of injection per day
...
is.na(mh1$MHORES07) & str_detect(mh1$HOW_LONG,"^$|pattern") |
...
`r if(is.character(params$data15)){knitr::asis_output("MHORES02 and MHORES03(How long has the subject been using insulin?) should not be blank at the same time")}` `r if(is.character(params$data15)){colorize(mh1[is.na(mh1$MHORES02) & str_detect(mh1$MHORES03,"^$|pattern"),]$Subject,"red")}`

`r if(is.character(params$data15)){knitr::asis_output("MHORES04(Does the subject use a pump for insulin administration?) should be either Yes or No")}` `r if(is.character(params$data15)){colorize(mh1[!str_detect(mh1$MHORES04,regex("Yes|No",ignore_case = T)),]$Subject,"red")}`

`r if(is.character(params$data15)){knitr::asis_output("MHORES05(Does the subject require multiple daily insulin injections?) should be either Yes or No")}` `r if(is.character(params$data15)){colorize(mh1[!str_detect(mh1$MHORES05,regex("Yes|No",ignore_case = T)),]$Subject,"red")}`

`r if(is.character(params$data15)){knitr::asis_output("If MHORES05(Does the subject require multiple daily insulin injections?) is Yes, MHDTC03(Start date of insulin injection) and MHORES06(Number of injections per day) should not be blank")}` `r if(is.character(params$data15)){colorize(mh1[str_detect(mh1$MHORES05,regex("Yes",ignore_case = T)) & (is.na(mh1$MHDTC03) | is.na(mh1$MHORES06)),]$Subject,"red")}`

`r if(is.character(params$data15)){knitr::asis_output("MHORES07 and HOW_LONG(How long has the subject been using the the current method of insulin administration?) should not be blank at the same time")}` `r if(is.character(params$data15)){colorize(mh1[is.na(mh1$MHORES07) & str_detect(mh1$HOW_LONG,"^$|pattern"),]$Subject,"red")}`

`r if(is.character(params$data15)){knitr::asis_output("MHORES09(Total daily insulin dose (approximate)) should not be blank")}` `r if(is.character(params$data15)){colorize(mh1[is.na(mh1$MHORES09),]$Subject,"red")}`
...
`r if(is.character(params$data16)){htmltools::a("Protocol Deviation Report",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/Protocol_Deviation_Report.pdf")}`
...
`r if(is.character(params$data17)){htmltools::a("Quality Control Check – YSI",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/QC_CheckYSI.pdf")}`
...
`r if(is.character(params$data18)){htmltools::a("Quality Control Check – YSI",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/QC_CheckYSI.pdf")}`
...
`r if(is.character(params$data20)){knitr::asis_output("# **SA2 Review**")}`

`r if(is.character(params$data20)){htmltools::a("Sensor Application",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/SensorApplication_Site.pdf")}`

```{r}
# sa2 <- read_sas(gsub("\\\\", "/", r"(\\wf00168p.oneabbott.com\data1\CDM\ADC-US-RES-21217\SE01\Openclinica\Current\sa2.sas7bdat)"))
# sa2 <- read_sas(gsub("\\\\", "/", r"(\\wf00168p.oneabbott.com\data1\CDM\ADC-US-VAL-21216\Openclinica\Current\sa2.sas7bdat)"))
```

```{r Load sa2, eval=is.character(params$data20)}
sa2 <- read_sas(params$data20)
sa2 <- sa2 %>% 
       mutate(Subject = as.character(Subject)) %>% 
       arrange(Subject)
```

```{r sa2, eval=is.character(params$data20)}
htmltools::browsable(
   tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download as CSV"),
      onclick = "Reactable.downloadDataCSV('sa2', 'sa2.csv')"
    ),
sa2[
# Sensor number (N)
is.na(sa2$DUSSEQ01) |
# Condition code: (C)
is.na(sa2$DUCCOD01) | str_detect(sa2$DUCCOD01,"^$|pattern") |
# Length of Condition code:
str_length(sa2$DUCCOD01) != median(str_length(sa2$DUCCOD01),na.rm = T) |
# Reading Device serial number (C)
is.na(sa2$DUSSPID01) | str_detect(sa2$DUSSPID01,"^$|pattern") | str_detect(sa2$DUSSPID01,"n/a") |
# Length of Reading Device serial number (C)
str_length(sa2$DUSSPID01) != median(str_length(sa2$DUSSPID01),na.rm = T) |
# Sensor Kit Lot Number (C)
is.na(sa2$DUSSPID02) | str_detect(sa2$DUSSPID02,"^$|pattern") |
# Length of Sensor Kit Lot Number
str_length(sa2$DUSSPID02) != median(str_length(sa2$DUSSPID02),na.rm = T) |
# Sensor Serial Number (C)
is.na(sa2$DUSSPID03) | str_detect(sa2$DUSSPID03,"^$|pattern") |
# Length of Sensor Serial Number
str_length(sa2$DUSSPID03) != median(str_length(sa2$DUSSPID03),na.rm = T) |
# Application Date (C)
is.na(sa2$DUDDTC02) | str_detect(sa2$DUDDTC02,"^$|pattern") |
# Length of Application Date 
str_length(sa2$DUDDTC02) != median(str_length(sa2$DUDDTC02),na.rm = T) |
# Application Time (C)
is.na(sa2$DUTTM01) | str_detect(sa2$DUTTM01,"^$|pattern")   |
# Length of Application Time 
str_length(sa2$DUTTM01) != median(str_length(sa2$DUTTM01),na.rm = T)   |
# Application Location (C)
!str_detect(sa2$DULLOC01,regex("Left Arm|Right Arm|Left Abdomen|Right Abdomen",ignore_case = T))                                                          |
# Was Sensor application successful? (C)
!str_detect(sa2$DUORRES01,regex("Yes|No",ignore_case = T))                      |
# Who performed the application of the sensor? (C)
!str_detect(sa2$DUOTTH02,regex("Site Staff|Subject|Parent or Guardian",ignore_case = T))                      |
# Were you able to Start New Sensor? (C)
!str_detect(sa2$DUORRES02,regex("Yes|No",ignore_case = T))                      |
# How many Scan attempts were required? (C)
is.na(sa2$DUORRES03) | str_detect(sa2$DUORRES03,"^$|pattern")   |
# Subject's assessment of pain (C)
!str_detect(sa2$DUORRES04,regex("No Pain|Slight Pain|Mild Pain|Moderate Pain|Extreme Pain",ignore_case = T)) |
# Subject's assessment of bleeding (C)
!str_detect(sa2$DUORRES05,regex("No Bleeding|Slight Bleeding|Mild Bleeding|Moderate Bleeding|Extreme Bleeding|Unacceptable Bleeding",ignore_case = T)) |
# Was the sensor functional? (C)
!str_detect(sa2$DUORRES06,regex("Yes|No",ignore_case = T)),] %>%
  select(-c(`StudyStatus`,`SubjectID`:`__ITEMGROUPREPEATKEY`)) %>%
  reactable(paginationType = "jump", striped = TRUE, highlight = TRUE, searchable = TRUE, defaultPageSize = 6, resizable = TRUE, filterable = TRUE,elementId = "sa2",
     defaultColDef = colDef(align = "center",minWidth = 115),
     columns = list(Subject = colDef(sticky = "left"))
     )
  )
...
`r if(is.character(params$data20) && is_empty(sa2$Subject)){knitr::asis_output(colorize("SA2 is empty","red"))}`

`r if(is.character(params$data20)){knitr::asis_output("DUSSEQ01(Sensor number) should not be blank")}` `r if(is.character(params$data20)){colorize(sa2[is.na(sa2$DUSSEQ01),]$Subject,"red")}`

`r if(is.character(params$data20)){knitr::asis_output("DUCCOD01(Condition code:) should not be blank")}` `r if(is.character(params$data20)){colorize(sa2[is.na(sa2$DUCCOD01) | str_detect(sa2$DUCCOD01,"^$|pattern"),]$Subject,"red")}` `r if(is.character(params$data20)){knitr::asis_output("and the length of DUCCOD01(Condition code:) should be")}` `r if(is.character(params$data20)){colorize(median(str_length(sa2$DUCCOD01),na.rm = T),"red")}` `r if(is.character(params$data20)){colorize(sa2[str_length(sa2$DUCCOD01) != median(str_length(sa2$DUCCOD01),na.rm = T),]$Subject,"red")}`

`r if(is.character(params$data20)){knitr::asis_output("DUSSPID01(Reading Device serial number) should not be blank")}` `r if(is.character(params$data20)){colorize(sa2[is.na(sa2$DUSSPID01) | str_detect(sa2$DUSSPID01,"^$|pattern") | str_detect(sa2$DUSSPID01,"n/a"),]$Subject,"red")}` `r if(is.character(params$data20)){knitr::asis_output("and the length of DUSSPID01(Reading Device serial number) should be")}` `r if(is.character(params$data20)){colorize(median(str_length(sa2$DUSSPID01),na.rm = T),"red")}` `r if(is.character(params$data20)){colorize(sa2[str_length(sa2$DUSSPID01) != median(str_length(sa2$DUSSPID01),na.rm = T),]$Subject,"red")}`

`r if(is.character(params$data20)){knitr::asis_output("DUSSPID02(Sensor Kit Lot Number) should not be blank")}` `r if(is.character(params$data20)){colorize(sa2[is.na(sa2$DUSSPID02) | str_detect(sa2$DUSSPID02,"^$|pattern"),]$Subject,"red")}` `r if(is.character(params$data20)){knitr::asis_output("and the length of DUSSPID02(Sensor Kit Lot Number) should be")}` `r if(is.character(params$data20)){colorize(median(str_length(sa2$DUSSPID02),na.rm = T),"red")}` `r if(is.character(params$data20)){colorize(sa2[str_length(sa2$DUSSPID02) != median(str_length(sa2$DUSSPID02),na.rm = T),]$Subject,"red")}`

`r if(is.character(params$data20)){knitr::asis_output("DUSSPID03(Sensor Serial Number) should not be blank")}` `r if(is.character(params$data20)){colorize(sa2[is.na(sa2$DUSSPID03) | str_detect(sa2$DUSSPID03,"^$|pattern"),]$Subject,"red")}` `r if(is.character(params$data20)){knitr::asis_output("and the length of DUSSPID03(Sensor Serial Number) should be")}` `r if(is.character(params$data20)){colorize(median(str_length(sa2$DUSSPID03),na.rm = T),"red")}` `r if(is.character(params$data20)){colorize(sa2[str_length(sa2$DUSSPID03) != median(str_length(sa2$DUSSPID03),na.rm = T),]$Subject,"red")}`

`r if(is.character(params$data20)){knitr::asis_output("DUDDTC02(Application Date) should not be blank")}` `r if(is.character(params$data20)){colorize(sa2[is.na(sa2$DUDDTC02) | str_detect(sa2$DUDDTC02,"^$|pattern"),]$Subject,"red")}`

`r if(is.character(params$data20)){knitr::asis_output("Length of DUDDTC02(Application Date) should be")}` `r if(is.character(params$data20)){colorize(median(str_length(sa2$DUDDTC02),na.rm = T),"red")}` `r if(is.character(params$data20)){colorize(sa2[str_length(sa2$DUDDTC02) != median(str_length(sa2$DUDDTC02),na.rm = T),]$Subject,"red")}`

`r if(is.character(params$data20)){knitr::asis_output("DUTTM01(Application Time) should not be blank")}` `r if(is.character(params$data20)){colorize(sa2[is.na(sa2$DUTTM01) | str_detect(sa2$DUTTM01,"^$|pattern"),]$Subject,"red")}`

`r if(is.character(params$data20)){knitr::asis_output("Length of DUTTM01(Application Time) should be")}` `r if(is.character(params$data20)){colorize(median(str_length(sa2$DUTTM01),na.rm = T),"red")}` `r if(is.character(params$data20)){colorize(sa2[str_length(sa2$DUTTM01) != median(str_length(sa2$DUTTM01),na.rm = T),]$Subject,"red")}`

`r if(is.character(params$data20)){knitr::asis_output("DULLOC01(Application Location) should be either Left Arm or Right Arm")}` `r if(is.character(params$data20)){colorize(sa2[!str_detect(sa2$DULLOC01,regex("Left Arm|Right Arm|Left Abdomen|Right Abdomen",ignore_case = T)),]$Subject,"red")}`

`r if(is.character(params$data20)){knitr::asis_output("DUORRES01(Was Sensor application successful?) should be either Yes or No")}` `r if(is.character(params$data20)){colorize(sa2[!str_detect(sa2$DUORRES01,regex("Yes|No",ignore_case = T)),]$Subject,"red")}`

`r if(is.character(params$data20)){knitr::asis_output("DUOTTH02(Who performed the application of the sensor?) should be either Site Staff, Subject, Parent or Guardian")}` `r if(is.character(params$data20)){colorize(sa2[!str_detect(sa2$DUOTTH02,regex("Site Staff|Subject|Parent or Guardian",ignore_case = T)),]$Subject,"red")}`

`r if(is.character(params$data20)){knitr::asis_output("DUORRES02(Were you able to Start New Sensor?) should be either Yes or No")}` `r if(is.character(params$data20)){colorize(sa2[!str_detect(sa2$DUORRES02,regex("Yes|No",ignore_case = T)),]$Subject,"red")}`

`r if(is.character(params$data20)){knitr::asis_output("DUORRES03(How many Scan attempts were required?) should not be blank")}` `r if(is.character(params$data20)){colorize(sa2[is.na(sa2$DUORRES03) | str_detect(sa2$DUORRES03,"^$|pattern"),]$Subject,"red")}`

`r if(is.character(params$data20)){knitr::asis_output("DUORRES04(Subject's assessment of pain) should be either No Pain,Slight Pain,Mild Pain,Moderate Pain,Extreme Pain")}` `r if(is.character(params$data20)){colorize(sa2[!str_detect(sa2$DUORRES04,regex("No Pain|Slight Pain|Mild Pain|Moderate Pain|Extreme Pain",ignore_case = T)),]$Subject,"red")}`

`r if(is.character(params$data20)){knitr::asis_output("DUORRES05(Subject's assessment of bleeding) should be either No Bleeding,Slight Bleeding,Mild Bleeding,Moderate Bleeding,Extreme Bleeding,Unacceptable Bleeding")}` `r if(is.character(params$data20)){colorize(sa2[!str_detect(sa2$DUORRES05,regex("No Bleeding|Slight Bleeding|Mild Bleeding|Moderate Bleeding|Extreme Bleeding|Unacceptable Bleeding",ignore_case = T)),]$Subject,"red")}`

`r if(is.character(params$data20)){knitr::asis_output("DUORRES06(Was the sensor functional?) should be either Yes or No")}` `r if(is.character(params$data20)){colorize(sa2[!str_detect(sa2$DUORRES06,regex("Yes|No",ignore_case = T)),]$Subject,"red")}`
...
`r if(is.character(params$data21)){htmltools::a("Study Exit",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/Study_Exit.pdf")}`
...
`r if(is.character(params$data22)){htmltools::a("Skin Assessment",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/Skin_Assessment.pdf")}`
...
sk1 <- sk1 %>% 
       filter(!str_detect(PEYN,regex("CHECK HERE IF NO DATA RECORDED|no_data_recorded",ignore_case = T))) %>%
       mutate(Subject = as.character(Subject)) %>% 
       arrange(Subject)
```
...
sk1[
# Visit Date (C)
(is.na(sk1$PEDTC) | str_detect(sk1$PEDTC,"^$|pattern"))  |
# Length of Visit Date
str_length(sk1$PEDTC) != median(str_length(sk1$PEDTC),na.rm = T),] %>%
  select(-c(`StudyStatus`,`SubjectID`:`__ITEMGROUPREPEATKEY`)) %>%
...
`r if(is.character(params$data22)){knitr::asis_output("PEDTC(Visit Date) should not be blank")}` `r if(is.character(params$data22)){colorize(sk1[is.na(sk1$PEDTC),]$Subject,"red")}`

`r if(is.character(params$data22)){knitr::asis_output("Length of PEDTC(Visit Date) should be")}` `r if(is.character(params$data22)){colorize(median(str_length(sk1$PEDTC),na.rm = T),"red")}`
`r if(is.character(params$data22)){colorize(sk1[str_length(sk1$PEDTC) != median(str_length(sk1$PEDTC),na.rm = T),]$Subject,"red")}`
...
`r if(is.character(params$data23)){htmltools::a("Skin Assessment",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/Skin_Assessment.pdf")}`
...
sk2[
# Assessment (C)
!str_detect(sk2$PELOC,regex("Left Arm|Right Arm|Left Abdomen|Right Abdomen",ignore_case = T)) |
...
!str_detect(sk2$PEORRES4,"1=Significant\\(shaving required\\)|2=Non-significant") |
# Dry Skin score (C)
...
str_detect(sk2$PEORRES6,regex("Yes",ignore_case = T)) & is.na(sk2$PEORRES7)             |
# Scarring score (C)
!str_detect(sk2$PEORRES8,regex("Yes|No",ignore_case = T))                               |
# If Yes, Scarring Area (cm2) (N)
str_detect(sk2$PEORRES8,regex("Yes",ignore_case = T)) & is.na(sk2$PEORRES9)             |
...
`r if(is.character(params$data23)){knitr::asis_output("PELOC(Assessment) should be either Left Arm or Right Arm or Left Abdomen or Right Abdomen")}` `r if(is.character(params$data23)){colorize(sk2[!str_detect(sk2$PELOC,regex("Left Arm|Right Arm|Left Abdomen|Right Abdomen",ignore_case = T)),]$Subject,"red")}`

`r if(is.character(params$data23)){knitr::asis_output("PEORRES1(General skin tone score) should be 1=Poor,2=Average,3=Good")}` `r if(is.character(params$data23)){colorize(sk2[!str_detect(sk2$PEORRES1,regex("1=Poor|2=Average|3=Good",ignore_case = T)),]$Subject,"red")}`

`r if(is.character(params$data23)){knitr::asis_output("PEORRES2(Cellulite score) should be 1=Significant, 2=Average, 3=Minor")}` `r if(is.character(params$data23)){colorize(sk2[!str_detect(sk2$PEORRES2,regex("1=Significant|2=Average|3=Minor",ignore_case = T)),]$Subject,"red")}`

`r if(is.character(params$data23)){knitr::asis_output("PEORRES3(Fine Lines Wrinkles score) should be 1=Significant, 2=Average, 3=Minor")}` `r if(is.character(params$data23)){colorize(sk2[!str_detect(sk2$PEORRES3,regex("1=Significant|2=Average|3=Minor",ignore_case = T)),]$Subject,"red")}`

`r if(is.character(params$data23)){knitr::asis_output("PEORRES4(Hair Coverage score) should be 1=Significant(shaving required), 2=Non-significant")}` `r if(is.character(params$data23)){colorize(sk2[!str_detect(sk2$PEORRES4,"1=Significant\\(shaving required\\)|2=Non-significant"),]$Subject,"red")}`

`r if(is.character(params$data23)){knitr::asis_output("PEORRES5(Dry Skin score) should be 1=Significant(Flaky),2=Non-significant")}` `r if(is.character(params$data23)){colorize(sk2[!str_detect(sk2$PEORRES5,regex("1=Significant\\(Flaky\\)|2=Non-significant",ignore_case = T)),]$Subject,"red")}`

`r if(is.character(params$data23)){knitr::asis_output("PEORRES6(Scabbing score) should be Yes or No")}` `r if(is.character(params$data23)){colorize(sk2[!str_detect(sk2$PEORRES6,regex("Yes|No",ignore_case = T)),]$Subject,"red")}`

`r if(is.character(params$data23)){knitr::asis_output("If PEORRES6(Scabbing score) is Yes, PEORRES7(Scabbing Area (cm2)) should not be blank")}` `r if(is.character(params$data23)){colorize(sk2[str_detect(sk2$PEORRES6,regex("Yes",ignore_case = T)) & is.na(sk2$PEORRES7),]$Subject,"red")}`

`r if(is.character(params$data23)){knitr::asis_output("PEORRES8(Scarring score) should be Yes or No")}` `r if(is.character(params$data23)){colorize(sk2[!str_detect(sk2$PEORRES8,regex("Yes|No",ignore_case = T)),]$Subject,"red")}`

`r if(is.character(params$data23)){knitr::asis_output("If PEORRES8(Scabbing score) is Yes, PEORRES9(Scarring Area (cm2)) should not be blank")}` `r if(is.character(params$data23)){colorize(sk2[str_detect(sk2$PEORRES8,regex("Yes",ignore_case = T)) & is.na(sk2$PEORRES9) ,]$Subject,"red")}`

`r if(is.character(params$data23)){knitr::asis_output("PEORRES10(Hypo/Hyperpigmentation score) should be Yes or No")}` `r if(is.character(params$data23)){colorize(sk2[!str_detect(sk2$PEORES10,regex("Yes|No",ignore_case = T)),]$Subject,"red")}`

`r if(is.character(params$data23)){knitr::asis_output("If PEORRES10(Hypo/Hyperpigmentation score) is Yes, PEORES11(Hypo/Hyperpigmentation Area (cm2)) should not be blank")}` `r if(is.character(params$data23)){colorize(sk2[str_detect(sk2$PEORES10,regex("Yes",ignore_case = T)) & is.na(sk2$PEORES11) ,]$Subject,"red")}`
...
`r if(is.character(params$data24)){htmltools::a("Study Set-up",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/Study_Setup.pdf")}`
...
sl1 <- sl1 %>% 
       filter(!str_detect(SLYN01,regex("CHECK HERE IF NO DATA RECORDED|no_data_recorded",ignore_case = T))) %>%
       mutate(Subject = as.character(Subject)) %>% 
       arrange(Subject)
```
...
`r if(is.character(params$data25)){htmltools::a("Study Set-up",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/Study_Setup.pdf")}`
...
`r if(is.character(params$data26)){htmltools::a("Study Set-up",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/Study_Setup.pdf")}`
...
`r if(is.character(params$data27)){htmltools::a("Sensor Removal",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/Sensor_Removal.pdf")}`
...
`r if(is.character(params$data28)){htmltools::a("Height and Weight",href = "//oneabbott.com/dept/ADC/Technical_OPS/Clinical_Affairs/Clinical Study Files/Apollo/ADC-US-RES-21217 Vitamin C Events/Case Report Forms/Version A/Approved/PDF_file/Height_Weight.pdf")}`
